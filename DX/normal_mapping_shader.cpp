...
void NormalMappingShader::InitShader(sz::ConstBufManager &buf_man,unsigned int lights_num) {
...
void NormalMappingShader::Render(ID3D11DeviceContext* deviceContext,
  size_t index_count,
  size_t index_start,
  size_t base_vertex)
{
