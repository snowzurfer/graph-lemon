...
NormalMappingShader::NormalMappingShader(ID3D11Device* device, HWND hwnd,
...
void NormalMappingShader::InitShader(szgrh::ConstBufManager &buf_man,unsigned int lights_num) {
	...
	loadVertexShader(polygon_layout, 4, L"../shaders/normal_map_vs.hlsl");
	loadPixelShader(L"../shaders/normal_map_ps.hlsl");
...
void NormalMappingShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, 
...
void NormalMappingShader::SetShaderFrameParameters(
  ...
  void NormalMappingShader::Render(ID3D11DeviceContext* deviceContext, int indexCount)
{
