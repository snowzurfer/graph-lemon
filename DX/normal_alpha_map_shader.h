// Normal mapping shader  with alpha mapping
// Shader which uses normal maps to perform per-pixel lighting 
// and alpha mapping
#ifndef _NORMAL_ALPHA_MAP_SHADER_H
#define _NORMAL_ALPHA_MAP_SHADER_H 
...
class NormalAlphaMapShader : public BaseShader
{
private:

public:

	NormalAlphaMapShader(ID3D11Device* device, HWND hwnd, 
    szgrh::ConstBufManager &buf_man, unsigned int lights_num);
	~NormalAlphaMapShader();
