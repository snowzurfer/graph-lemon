...
LightSpecMapShader::LightSpecMapShader(ID3D11Device* device, HWND hwnd, 
  szgrh::ConstBufManager &buf_man, unsigned int lights_num) : 
	...
	InitShader(buf_man, L"../shaders/light_spec_map_vs.hlsl", 
    L"../shaders/light_spec_map_ps.hlsl", lights_num);
}


LightSpecMapShader::~LightSpecMapShader() {
...
void LightSpecMapShader::InitShader(szgrh::ConstBufManager &buf_man, 
...
void LightSpecMapShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, 
...
void LightSpecMapShader::SetShaderFrameParameters(ID3D11DeviceContext* deviceContext, std::vector<Light> &lights, Camera *cam) {
  ...
  void LightSpecMapShader::Render(ID3D11DeviceContext* deviceContext, int indexCount)
{
