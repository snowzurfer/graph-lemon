...
NormalSpecMapShader::NormalSpecMapShader(ID3D11Device* device, HWND hwnd,
...
NormalSpecMapShader::~NormalSpecMapShader() {
...
void NormalSpecMapShader::InitShader(sz::ConstBufManager &buf_man,
  ...
  loadVertexShader(polygon_layout, 4, L"../shaders/normal_spec_map_vs.hlsl");
  ...
  loadPixelShader(L"../shaders/normal_spec_map_ps.hlsl");
...
void NormalSpecMapShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, 
...
void NormalSpecMapShader::SetShaderFrameParameters(
  ...
  void NormalSpecMapShader::Render(ID3D11DeviceContext* deviceContext,
    size_t index_count,
    size_t index_start,
    size_t base_vertex)
{
