...
void NormalAlphaSpecMapShader::InitShader(szgrh::ConstBufManager &buf_man,unsigned int lights_num) {
...
void NormalAlphaSpecMapShader::SetShaderFrameParameters(
  ...
  void NormalAlphaSpecMapShader::Render(ID3D11DeviceContext* deviceContext, int indexCount)
{
