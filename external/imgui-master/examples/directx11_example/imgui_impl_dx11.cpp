...
void ImGui_ImplDX11_RenderDrawLists(ImDrawData* draw_data)
{
    ...
    g_pd3dDeviceContext->RSGetViewports(&num_viewports, vp);
    // Setup viewport
    {
        D3D11_VIEWPORT vp;
    ...
    //g_pd3dDeviceContext->OMSetBlendState(g_pBlendState_local, blendFactor_local, *pSampleMask);
    //g_pd3dDeviceContext->RSSetViewports(num_viewports, vp);
}
